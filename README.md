...
* `-e 'HEALTHCHECK_ID=3059....`: if the variable is set, call the service healthcheck.io confirming the execution of the script (supports also elapsed time measurment and fail signaling)
